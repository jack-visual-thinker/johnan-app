...
export const QUESTIONS: Question[] = [
  ...
  { id: 6, text: '困難なトラブルが起きたとき、「困った」と落ち込むより、「腕の見せ所だ」と逆に燃えてくる。', image: '/images/Q6Image.png', parameterKey: 'Responsibility' },
  { id: 7, text: 'もし会社やチームが間違ったことをしようとしたら、空気を読まずに「それは違う」と言う覚悟がある。', image: '/images/Q7Image.png', parameterKey: 'UniversalTruth' },
  { id: 8, text: 'ルールや利益も大事だが、それ以上に「人としての自由」や「愛」が守られているかを重視する。', image: '/images/Q8Image.png', parameterKey: 'UniversalTruth' },
  { id: 9, text: '人生の転機を振り返ると、自分の計算や努力だけでは説明できない「不思議な巡り合わせ」に助けられたと感じる。', image: '/images/Q9Image.png', parameterKey: 'DivineGuidance' },
  { id: 10, text: '根拠はなくても「最終的には絶対うまくいく」という謎の自信や安心感を持っていることが多い。', image: '/images/Q10Image.png', parameterKey: 'DivineGuidance' },
  { id: 11, text: '目の前の仕事が、10年後や100年後の未来にどうつながるかを想像しながら取り組んでいる。', image: '/images/Q11Image.png', parameterKey: 'Mission' },
